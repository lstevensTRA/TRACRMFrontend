...
export const getCases = async (): Promise<TRACase[]> => {
  try {
    ...
    const queryUrl = `${DATAVERSE_BASE_URL}/incidents?$select=incidentid,title,statecode,statuscode,prioritycode,createdon,modifiedon,description,_customerid_value&$top=100`;
